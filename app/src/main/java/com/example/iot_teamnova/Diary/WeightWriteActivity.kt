...
import com.example.iot_teamnova.Retrofit.WeightWriteModel
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
import java.util.*

class WeightWriteActivity : Activity() {
    var dateString = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val petIdx = intent.getStringExtra("idx")
        ...
        confirmBtn.setOnClickListener {
            ...
            if(weight == "0") {
                ...
                api.post_weight_write(petIdx, data).enqueue(object : Callback<PostResult> {
