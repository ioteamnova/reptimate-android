...
import com.example.iot_teamnova.HomeActivity
...
import com.example.iot_teamnova.Retrofit.GoogleLoginModel
import com.example.iot_teamnova.Retrofit.KakaoLoginModel
import com.example.iot_teamnova.Retrofit.LoginModel
import com.example.iot_teamnova.Retrofit.PostResult
import com.example.iot_teamnova.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(applicationContext).load(com.example.iot_teamnova.R.drawable.login_logo).into(binding.loginLogo)
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                    .requestIdToken(getString(com.example.iot_teamnova.R.string.default_web_client_id))
                    .requestEmail()
                    .build()
