...
import com.reptimate.iot_teamnova.Retrofit.ScheduleWriteModel
import com.reptimate.iot_teamnova.databinding.ActivityScheduleScheduleWriteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.confirmBtn.setOnClickListener {
            ...
            if (title == "") {
                ...
                api.post_schedule_edit(getIdx,data).enqueue(object : Callback<PostResult> {
